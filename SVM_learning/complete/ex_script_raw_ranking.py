...
def wraper_npy(inp):
    fv_raw_test = np.load('/home/Hao/Work/Cmts/raw/total_testing' + inp + '.npy')
    fv_raw_train = np.load('/home/Hao/Work/Cmts/raw/total_training' + inp + '.npy')
    ...
    np.save('/home/Hao/Work/Cmts/raw/raw_test_mid_rep' + inp, raw_mid_test_group)
    np.save('/home/Hao/Work/Cmts/raw/raw_train_mid_rep' + inp, raw_mid_train_group)
    ...
    np.save('/home/Hao/Work/Cmts/raw/raw_test_mid_cal_rep' + inp, raw_mid_test_group_cal)
    np.save('/home/Hao/Work/Cmts/raw/raw_train_mid_cal_rep' + inp, raw_mid_train_group_cal)
    ...
    np.save('/home/Hao/Work/Cmts/raw/raw_test_mid_stack_rep' + inp, raw_mid_test_stack)
    np.save('/home/Hao/Work/Cmts/raw/raw_train_mid_stack_rep' + inp, raw_mid_train_stack)

    raw_mid_test_stack_mix = raw_mid_test_stack_mix.T
    raw_mid_train_stack_mix = raw_mid_train_stack_mix.T
    np.save('/home/Hao/Work/Cmts/raw/raw_test_mid_stack_mixed_rep' + inp, raw_mid_test_stack_mix)
    np.save('/home/Hao/Work/Cmts/raw/raw_train_mid_stack_mixed_rep' + inp, raw_mid_train_stack_mix)
    ...
    np.save('/home/Hao/Work/Cmts/raw/raw_test_mid_mixed_rep' + inp, raw_mid_test)
    np.save('/home/Hao/Work/Cmts/raw/raw_train_mid_mixed_rep' + inp, raw_mid_train)
    ...
    np.save('/home/Hao/Work/Cmts/raw/raw_test_mid_mixed_cal_rep' + inp, raw_mid_test_cal)
    np.save('/home/Hao/Work/Cmts/raw/raw_train_mid_mixed_cal_rep' + inp, raw_mid_train_cal)
